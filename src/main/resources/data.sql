...
INSERT INTO public.goods (id, price, name, description, type_id) VALUES (1, 100, 'cute t shirt', 'really cute shirt', 1);
INSERT INTO public.goods (id, price, name, description, type_id) VALUES (2, 200, 'cool sweatshirt', 'really cute sweatshirt', 1);
...
INSERT INTO public.users (id, login, password, email, address_id, rights) VALUES (1, 'login', 'password', 'scheisse@shit.kso', 1, 0);

INSERT INTO public.orders (id, address_id, creation_date, phone, user_id) VALUES (1, NULL , '2017-03-14', 79111233456, 1);
INSERT INTO public.orders (id, address_id, creation_date, phone, user_id) VALUES (2, NULL , '2017-03-18', 79291234567, 1);
